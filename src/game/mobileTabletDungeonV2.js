...
function syncUiScale(game) {
  ...
  set('--t-mini-w', `${Math.round(118 * k)}px`)
  set('--t-stick', `${Math.round(108 * k)}px`)
  set('--t-stick-knob', `${Math.round(44 * k)}px`)
  set('--t-action', `${Math.round(51 * k)}px`)
  set('--t-attack', `${Math.round(66 * k)}px`)
  set('--t-action-gap', `${Math.max(5, Math.round(7 * k))}px`)
