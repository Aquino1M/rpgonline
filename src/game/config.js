...
export const CITIES = [
  ...
  {id:'lumen-city',zoneId:'meadow',name:'Bastião Lúmen',x:152,z:18,halfW:27,halfH:25,radius:29,wallRadius:29,style:'meadow',accent:'#d8f58e',wall:0xc1ad72,roof:0xa66f35,services:[
    ...
    {id:'lumen-guild',role:'guild',name:'Varek',title:'Suboficial da Guilda',x:156,z:8,color:0xeab308},
  ...
  {id:'cinerea-city',zoneId:'forest',name:'Refúgio Cinéreo',x:-154,z:0,halfW:25,halfH:26,radius:28,wallRadius:28,style:'forest',accent:'#80a58a',wall:0x6f7766,roof:0x4f5944,services:[
    {id:'forest-quest',role:'quest',name:'Eira',title:'Guardiã das Raízes (Missões)',x:-160,z:5,color:0x668d75},
    {id:'forest-guild',role:'guild',name:'Kaelis',title:'Oficial da Guilda',x:-146,z:-12,color:0xeab308},
  ...
  {id:'safira-city',zoneId:'coast',name:'Porto Safira',x:0,z:252,halfW:31,halfH:24,radius:33,wallRadius:33,style:'coast',accent:'#4bc1df',wall:0xb7b295,roof:0x477b92,services:[
    {id:'coast-quest',role:'quest',name:'Neris',title:'Capitã do Porto (Missões)',x:-7,z:248,color:0x5f8ab4},
    {id:'coast-guild',role:'guild',name:'Theron',title:'Mestre Portuário da Guilda',x:-12,z:258,color:0xeab308},
  ...
  {id:'veyra-city',zoneId:'highlands',name:'Fortaleza Veyra',x:245,z:225,halfW:28,halfH:27,radius:30,wallRadius:30,style:'stone',accent:'#c7d2c6',wall:0x969b91,roof:0x6d7383,services:[
    {id:'veyra-quest',role:'quest',name:'Sera',title:'Sentinela de Veyra (Missões)',x:239,z:219,color:0x8196b8},
    {id:'veyra-guild',role:'guild',name:'Darius',title:'Comandante da Guilda',x:242,z:232,color:0xeab308},
